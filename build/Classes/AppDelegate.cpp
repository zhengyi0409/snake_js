...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	CCLOG("C++ ------------------------------------ AppDelegate::applicationDidFinishLaunching()");
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::create("slither");
#else
        glview = GLViewImpl::createWithRect("slither", cocos2d::Rect(0,0,568,320));// 1136,640
#endif
    ...
    jsb_enable_debugger("0.0.0.0", 5090);
#endif
